...
<form class="form-inline" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
  ...
  <button type="submit" class="btn btn-primary">Extract details</button>
    ...
    <input type="text" class="form-control" id="product_id" name="product_id" value="<?=isset($row['product_id'])?$row['product_id']:""?>">
  </div>
  ...
  <label class="control-label col-sm-2" for="productName">Product Name:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter product name" value="<?=isset($row['product_name'])?$row['product_name']:""?>" required>
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="rate" name="rate" placeholder="Rate (price per piece)" value="<?=isset($row['rate'])?$row['rate']:""?>"required>
    </div>
  </div>
